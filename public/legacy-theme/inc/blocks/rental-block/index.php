...
class BlockRental
{
	...
	public function _enqueue_assets()
	{
		...
		wp_enqueue_style('theme/rental-block',GSE()::theme_uri().$path.'/block.css',array(),2);
		wp_enqueue_script('theme/rental-block',GSE()::theme_uri().$path.'/block.js',array(),2);
		return;
	}
