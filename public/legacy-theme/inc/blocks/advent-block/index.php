...
class BlockAdvant
{
	...
	public function _register()
	{
		acf_register_block_type(
			array(
				'name'              => 'advant-block',
				'title'             => 'Блок: Перимущества компании',
	...
	public function _enqueue_assets()
	{
		...
		wp_enqueue_style('theme/advant-block',GSE()::theme_uri().$path.'/block.css',array(),2);
		wp_enqueue_script('theme/advant-block',GSE()::theme_uri().$path.'/block.js',array(),2);
		return;
	}
