...
@section('body_class', 'single single-service')
@section('main_class', 'service-page')

@section('content')
    <article id="service-page" class="service-detail">
        <div class="container">
            <div class="content block-text">
                <h1 class="page-title">{{ $service->getAttribute('title') }}</h1>
                ...
                @if(!empty($servicePrices))
                    <section class="service-detail__prices">
                        <h2 class="has-text-align-center">Стоимость аренды</h2>
                        <p>Катамаран с доставкой, сборкой и комплектующими.</p>
                            ...
                            <table>
                                <tbody>
                                    @foreach($servicePrices as $price)
                                        <tr>
                                            <td class="has-text-align-left"><strong>{{ $price['label'] }}</strong></td>
                                            <td>{{ $price['price'] }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                    ...
                    <div class="swiper-wrapper">
                        @foreach($gallery['images'] as $image)
                            <div class="swiper-slide">
                                <div class="item">
                                    <div class="item__img" data-fancybox="gallery-service" data-src="{{ $image['url'] }}">
